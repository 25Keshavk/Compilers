...
public class TreeUtil  //method stubs /Skeleton code
{
    ...
    public static int countNodes(TreeNode t)
    {
            ...
            int leftDepth = countNodes(t.getLeft());
            int rightDepth = countNodes(t.getRight());
    ...
    public static int countLeaves(TreeNode t)
    {
        ...
        int leftCount = countLeaves(t.getLeft());
        int rightCount = countLeaves(t.getRight());
    ...
    public static void saveTree(String fileName, TreeNode t)
    {
        ...
        fillList(t,lis);
        FileUtil.saveFile(fileName,lis.iterator());
    ...
    public static TreeNode buildTree(Iterator<String> it)
    {
        if (it.hasNext()) {
            ...
            TreeNode tree = new TreeNode(nex);
    ...
    {
        TreeNode tree = loadTree("KnowledgeTree");
