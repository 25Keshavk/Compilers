...
/**
 * SimpleTest tests basic operations for MyLinkedList by comparing to Java's ArrayList.
 *
...
public class SimpleTestLL
{
    ...
    {
        String name = "Keshav Kotamraju"; 
        System.out.println("Tests MyLinkedList for "+ name); 
