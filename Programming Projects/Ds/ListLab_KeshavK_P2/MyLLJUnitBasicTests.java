 ...
 * @version Oct 2022  created basic tests for MyLinkedList 
 */
public class MyLLJUnitBasicTests
{

    MyLinkedList<String> empty ;
    MyLinkedList<Integer> five ;
    /**
     * Default constructor for test class MyALJUnit
     */
    public MyLLJUnitBasicTests()
    {
    }
    ...
    public void basicAddGetSetRemove()
    {
        ...
        //Add, append,  to both MyLinkedList and to java's list and compare.  
        for (int i =0; i < 15; i++)
        {
